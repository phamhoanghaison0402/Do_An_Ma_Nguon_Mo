      ...
      <div class="table-responsive wrapper">
        <table class="table table-bordered">
          ...
          <tr>
            <td></td>
            <?php foreach ($products as $product) { ?>
            <td><input type="button" value="<?php echo $button_cart; ?>" class="button btn btn-shopping-cart" onclick="cart.add('<?php echo $product['product_id']; ?>');" />
              <a href="<?php echo $product['remove']; ?>" class="button btn btn-danger"><?php echo $button_remove; ?></a></td>
            <?php } ?>
          </tr>
        </table>
